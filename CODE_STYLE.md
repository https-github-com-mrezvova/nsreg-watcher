...
Комментарии имеющие характер напоминания о действиях с кодом, отмечать тегом `TODO:`.
...
def bad_func()
    ...
```
В любой IDE есть плагины для быстрого поиска, анализа и работы с такими комментариями, а про обычный комментарий без тега, можно и забыть.
